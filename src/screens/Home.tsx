...
const Home: FC = () => {
    ...
    const renderTrendingShoes = ({ item, index }: any) => {
        let trendingStyle = {};
        if (index === 0) {
        ...
        return (
            <TouchableOpacity
                style={[styles.card, trendingStyle]}
            >
                <Text style={styles.type}>{item.type}</Text>
                <View style={[styles.content, { backgroundColor: item.bgColor }, styles.trendingShadow,]}>
                    <View style={{
                        height: "35%",
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.treading}>TRENDING</Text>
            {/* Trending */}
            <View style={styles.treadingContainer}>
                <FlatList
                    horizontal
